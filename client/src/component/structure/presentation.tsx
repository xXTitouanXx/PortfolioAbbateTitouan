            ...
            <Container className="flex flex-col items-center justify-center pt-16">
                ...
                <div className="flex flex-col md:flex-row w-full justify-center items-center">
                    <div className="p-4 space-y-4 flex-1">
                        <Typography variant="caption1" theme="Mauve" className="max-w-xl text-justify">
                            I'm a dedicated {age} year old developer driven by a passion for technology
                        ...
                        <Typography variant="caption1" theme="Mauve" className="max-w-xl text-justify">
                            My practical experience, gained through internships and personal projects, has granted me
